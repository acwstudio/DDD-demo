            ...
            <div class="col d-none d-lg-block">
                <nav class="main-menu">
                    <ul>
                        ...
                        <li><a href="#">INFO</a>
                            <ul class="sub-menu">
                                <li><a href="shop-4-column.html">About</a></li>
                                <li><a href="shop-4-column.html">Blog</a></li>
                            </ul>
                        </li>
            ...
            <div class="col">
                <div class="header-action">
                    ...
                    <div class="header-cart-wrap">
                        <!-- Cart Toggle -->
                        <button class="header-cart-toggle"><span class="icon">cart</span>
                            <span class="number">2</span><span class="price">$289</span></button>
                                ...
                                <div class="mini-cart-body-inner custom-scroll">
                                    <ul>
                                        ...
                                        <li class="mini-cart-product">
                                            <div class="image">
                                                <a href="#"><img src="{{ asset('shop/images/product/product-1.jpg') }}" alt=""></a>
                                        ...
                                        <li class="mini-cart-product">
                                            <div class="image">
                                                <a href="#"><img src="{{ asset('shop/images/product/product-2.jpg') }}" alt=""></a>
                                                <button class="remove"><i class="fa fa-trash-o"></i></button>
                                            </div>
                                            <div class="content">
                                        ...
                                        <li class="mini-cart-product">
                                            <div class="image">
                                                <a href="#"><img src="{{ asset('shop/images/product/product-3.jpg') }}" alt=""></a>
                                                <button class="remove"><i class="fa fa-trash-o"></i></button>
                                            </div>
                                            <div class="content">
                                        ...
                                        <li class="mini-cart-product">
                                            <div class="image">
                                                <a href="#"><img src="{{ asset('shop/images/product/product-4.jpg') }}" alt=""></a>
                                                <button class="remove"><i class="fa fa-trash-o"></i></button>
                                            </div>
                                            <div class="content">
